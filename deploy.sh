...
if [ ! -f .env ]; then
  ...
  echo "=================================================================="
  echo " .env created. Edit digihub-git/backend/.env in File Manager"
...
if grep -q '^APP_ENV=local' .env; then
  echo "=================================================================="
  echo " .env still has APP_ENV=local. Edit digihub-git/backend/.env first,"
